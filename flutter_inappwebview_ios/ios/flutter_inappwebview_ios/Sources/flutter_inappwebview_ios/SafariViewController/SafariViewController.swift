...
public class SafariViewController: SFSafariViewController, SFSafariViewControllerDelegate, Disposable {
    ...
    @available(iOS 11.0, *)
    public init(plugin: TalkjsInAppWebViewFlutterPlugin, id: String, url: URL, configuration: SFSafariViewController.Configuration, menuItemList: [[String: Any]] = [], safariSettings: SafariBrowserSettings) {
        self.id = id
        self.plugin = plugin
    ...
    public init(plugin: TalkjsInAppWebViewFlutterPlugin, id: String, url: URL, entersReaderIfAvailable: Bool, menuItemList: [[String: Any]] = [], safariSettings: SafariBrowserSettings) {
        self.id = id
        self.plugin = plugin
        self.menuItemList = menuItemList
        self.safariSettings = safariSettings
