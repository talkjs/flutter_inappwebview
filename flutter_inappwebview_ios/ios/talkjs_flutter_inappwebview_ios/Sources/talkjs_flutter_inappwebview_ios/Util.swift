...
public class Util {
    public static func getUrlAsset(plugin: TalkjsInAppWebViewFlutterPlugin, assetFilePath: String) throws -> URL {
    ...
    public static func getAbsPathAsset(plugin: TalkjsInAppWebViewFlutterPlugin, assetFilePath: String) throws -> String {
        let key = plugin.registrar.lookupKey(forAsset: assetFilePath)
