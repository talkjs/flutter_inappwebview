...
public class PlatformUtil extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_inappwebview_platformutil";
  
  @Nullable
  public TalkJSInAppWebViewFlutterPlugin plugin;

  public PlatformUtil(final TalkJSInAppWebViewFlutterPlugin plugin) {
