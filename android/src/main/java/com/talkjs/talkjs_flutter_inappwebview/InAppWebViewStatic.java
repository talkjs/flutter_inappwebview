...
public class InAppWebViewStatic extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_inappwebview_static";
  
  @Nullable
  public TalkJSInAppWebViewFlutterPlugin plugin;

  public InAppWebViewStatic(final TalkJSInAppWebViewFlutterPlugin plugin) {
