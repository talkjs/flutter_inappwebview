package com.talkjs.talkjs_flutter_inappwebview.credential_database;
...
public class CredentialDatabaseHandler extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_inappwebview_credential_database";
  ...
  public CredentialDatabaseHandler(@NonNull final TalkJSInAppWebViewFlutterPlugin plugin) {
    super(new MethodChannel(plugin.messenger, METHOD_CHANNEL_NAME));
    this.plugin = plugin;
  }

  public static void init(@NonNull TalkJSInAppWebViewFlutterPlugin plugin) {
