package com.talkjs.talkjs_flutter_inappwebview.proxy;
...
import com.talkjs.talkjs_flutter_inappwebview.types.ProxyRuleExt;
...
public class ProxyManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_inappwebview_proxycontroller";
  ...
  public ProxyManager(@NonNull final TalkJSInAppWebViewFlutterPlugin plugin) {
