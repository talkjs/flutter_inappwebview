...
public class MyCookieManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_inappwebview_cookiemanager";
  @Nullable
  public static CookieManager cookieManager;
  @Nullable
  public TalkJSInAppWebViewFlutterPlugin plugin;

  public MyCookieManager(@NonNull final TalkJSInAppWebViewFlutterPlugin plugin) {
