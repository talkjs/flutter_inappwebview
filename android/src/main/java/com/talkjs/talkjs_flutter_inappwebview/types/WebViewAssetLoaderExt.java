...
public class WebViewAssetLoaderExt implements Disposable {
  ...
  @Nullable
  public static WebViewAssetLoaderExt fromMap(@Nullable Map<String, Object> map, @NonNull TalkJSInAppWebViewFlutterPlugin plugin, @NonNull Context context) {
    if (map == null) {
      return null;
    }
  ...
  public static class PathHandlerExt implements WebViewAssetLoader.PathHandler, Disposable {
    ...
    public static final String METHOD_CHANNEL_NAME_PREFIX = "com.talkjs/talkjs_flutter_inappwebview_custompathhandler_";
    ...
    public PathHandlerExt(@NonNull String id, @NonNull TalkJSInAppWebViewFlutterPlugin plugin) {
      this.id = id;
