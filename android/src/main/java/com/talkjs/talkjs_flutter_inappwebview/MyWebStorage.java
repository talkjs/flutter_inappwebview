...
public class MyWebStorage extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_inappwebview_webstoragemanager";
  ...
  public MyWebStorage(@NonNull final TalkJSInAppWebViewFlutterPlugin plugin) {
