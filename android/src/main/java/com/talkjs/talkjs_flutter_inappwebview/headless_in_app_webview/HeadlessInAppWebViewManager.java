...
public class HeadlessInAppWebViewManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_headless_inappwebview";
  
  public static final Map<String, HeadlessInAppWebView> webViews = new HashMap<>();
  @Nullable
  public TalkJSInAppWebViewFlutterPlugin plugin;

  public HeadlessInAppWebViewManager(final TalkJSInAppWebViewFlutterPlugin plugin) {
