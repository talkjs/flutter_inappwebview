package com.talkjs.talkjs_flutter_inappwebview.headless_in_app_webview;
...
public class HeadlessInAppWebView implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "com.talkjs/talkjs_flutter_headless_inappwebview_";
  ...
  public HeadlessInAppWebView(@NonNull final TalkJSInAppWebViewFlutterPlugin plugin, @NonNull String id, @NonNull FlutterWebView flutterWebView) {
    this.id = id;
    this.plugin = plugin;
