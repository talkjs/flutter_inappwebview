...
public interface InAppWebViewInterface {
  ...
  void postWebMessage(com.talkjs.talkjs_flutter_inappwebview.types.WebMessage message, Uri targetOrigin, ValueCallback<String> callback) throws Exception;
  ...
  TalkJSInAppWebViewFlutterPlugin getPlugin();
  void setPlugin(TalkJSInAppWebViewFlutterPlugin plugin);
