...
import com.talkjs.talkjs_flutter_inappwebview.credential_database.CredentialDatabase;
...
import com.talkjs.talkjs_flutter_inappwebview.types.URLCredential;
import com.talkjs.talkjs_flutter_inappwebview.types.URLProtectionSpace;
...
public class InAppWebViewClient extends WebViewClient {
  ...
  public void onSafeBrowsingHit(final WebView view, final WebResourceRequest request, final int threatType, final SafeBrowsingResponse callback) {
    ...
    final WebViewChannelDelegate.SafeBrowsingHitCallback resultCallback = new WebViewChannelDelegate.SafeBrowsingHitCallback() {
      @Override
      public boolean nonNullSuccess(@NonNull com.talkjs.talkjs_flutter_inappwebview.types.SafeBrowsingResponse response) {
        Integer action = response.getAction();
        if (action != null) {
      ...
      @Override
      public void defaultBehaviour(@Nullable com.talkjs.talkjs_flutter_inappwebview.types.SafeBrowsingResponse result) {
