...
public class ChromeSafariBrowserManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_chromesafaribrowser";
  ...
  public ChromeSafariBrowserManager(final TalkJSInAppWebViewFlutterPlugin plugin) {
