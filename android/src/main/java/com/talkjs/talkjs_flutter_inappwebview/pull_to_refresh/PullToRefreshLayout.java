package com.talkjs.talkjs_flutter_inappwebview.pull_to_refresh;
...
public class PullToRefreshLayout extends SwipeRefreshLayout implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME_PREFIX = "com.talkjs/talkjs_flutter_inappwebview_pull_to_refresh_";
  
  @Nullable
  public PullToRefreshChannelDelegate channelDelegate;
  public PullToRefreshSettings settings = new PullToRefreshSettings();

  public PullToRefreshLayout(@NonNull Context context, @NonNull TalkJSInAppWebViewFlutterPlugin plugin, 
