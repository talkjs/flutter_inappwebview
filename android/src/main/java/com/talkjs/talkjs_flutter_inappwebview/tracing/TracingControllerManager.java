package com.talkjs.talkjs_flutter_inappwebview.tracing;
...
public class TracingControllerManager implements Disposable {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.talkjs/talkjs_flutter_inappwebview_tracingcontroller";
  ...
  public TracingControllerManager(final TalkJSInAppWebViewFlutterPlugin plugin) {
    this.plugin = plugin;
