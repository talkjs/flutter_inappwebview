#ifndef TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_SAVE_AS_KIND_H_
#define TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_SAVE_AS_KIND_H_
...
#endif //TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_SAVE_AS_KIND_H_