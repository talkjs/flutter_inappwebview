...
public class HeadlessInAppWebView: Disposable {
    static let METHOD_CHANNEL_NAME_PREFIX = "com.talkjs/talkjs_flutter_headless_inappwebview_"
    var id: String
    ...
    public init(plugin: TalkjsInAppWebViewFlutterPlugin, id: String, flutterWebView: FlutterWebViewController) {
        self.id = id
