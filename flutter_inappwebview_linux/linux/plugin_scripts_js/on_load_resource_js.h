#ifndef TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_ON_LOAD_RESOURCE_JS_H_
#define TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_ON_LOAD_RESOURCE_JS_H_
...
#endif  // TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_ON_LOAD_RESOURCE_JS_H_
