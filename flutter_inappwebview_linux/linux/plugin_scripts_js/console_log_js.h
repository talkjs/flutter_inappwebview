#ifndef TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_CONSOLE_LOG_JS_H_
#define TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_CONSOLE_LOG_JS_H_
...
#endif  // TALKJS_FLUTTER_INAPPWEBVIEW_PLUGIN_CONSOLE_LOG_JS_H_
